        ...
        <%@ taglib uri="jakarta.tags.fmt" prefix="fmt" %>
            ...
            <body>
                <div class="container">
                    ...
                    <!-- Revenu total par salle -->
                    <c:if test="${not empty revenueParSalle}">
                        <div class="card stats-section">
                            <h3><i class="fas fa-chart-line"></i> Revenu total par salle</h3>
                            ...
                            <c:choose>
                                    ...
                                    <table class="table" id="originalTable">
                                        ...
                                        <tbody id="seancesBody">
                                            <c:forEach var="row" items="${seances}">
                                                <tr class="seance-row" data-film="${row.seance.film.titre}"
                                                    ...
                                                    data-seance-id="${row.seance.id}" data-revenue="${row.revenue}">
                                                    <!-- Ajout de l'ID de séance -->
                                                    <td class="film-cell">
                                                        <c:choose>
                                                    ...
                                                    <td class="duree-cell">
                                                        <c:if
                                                            test="${not empty row.seance.film and not empty row.seance.film.dureeMinutes}">
                                                    ...
                                                    <td class="langue-cell">
                                                        <span
                                                            class="langue-badge ${row.seance.langue == 'VF' ? 'langue-vf' : 'langue-vo'}">
                                                            ${row.seance.langue}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="action-cell">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/client/seances/${row.seance.id}/reserver"
                                                            class="btn-reserver" title="Réserver cette séance">
                                ...
                                <c:otherwise>
                                    <div style="text-align: center; padding: 40px;">
                                        ...
                                        <a href="${pageContext.request.contextPath}/client/accueil" class="btn-reserver"
